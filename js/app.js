...
async function abrirProva(listaId) {
  ...
  if (dados.jaRespondida) {
    ...
    conteudo.innerHTML = `<div class="alerta alerta-info">Você já respondeu esta atividade.
      ${dados.resultadoAnterior ? `Nota: ${dados.resultadoAnterior.acertos} acertos.` : ''}${avisoResolucao}</div>` +
  ...
  abrirModal(`<h3>Nova lista de atividades</h3>
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:8px;margin-top:8px;">
        <div style="flex:1;"><input id="filtro-lista-comp" placeholder="Componente (ex: Matemática)"></div>
        <div style="flex:1;">
...
window._filtrosBancoQuestoes = { busca: '', tipo: '', comp: '' };
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:8px;">
        <div style="flex:1;">
          ...
          <input id="filtro-q-comp" value="${escapeHtml(filtros.comp)}" placeholder="Ex: Matemática">
        </div>
        <div style="flex:1;">
          <label>Tipo</label>
